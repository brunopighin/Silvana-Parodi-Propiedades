...
export default function InstagramButton() {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-40 flex items-center gap-3">
      ...
      {/* Button */}
      <a
        href="https://www.instagram.com/silvanaparodipropiedades/"
        target="_blank"
        rel="noopener noreferrer"
        onMouseEnter={() => setHovered(true)}
        onMouseLeave={() => setHovered(false)}
        className="relative w-14 h-14 bg-gradient-to-br from-yellow-400 via-pink-500 to-purple-600 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
